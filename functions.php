...
// functions.php (add at bottom)
function buildWhatsAppAdminUrl(int $orderID, float $totalAmount, ?string $customerName): string {
    $admin = "916260096745"; // admin phone number without +
    $msg = "New Order Received!\n"
         . "Order ID: $orderID\n"
         . "Customer: " . ($customerName ?? 'Guest') . "\n"
         . "Total: ₹" . number_format($totalAmount, 2);
    return "https://wa.me/{$admin}?text=" . urlencode($msg);
}
